...
__all__ = ["Metric", "IterationMetric", "Cumulative", "CumulativeIterationMetric", "DiceMetric",
           "ComputeDice"]
...
class DiceMetric(nn.Module):
    def __init__(self, dims=(2, 3, 4), activation='sigmoid', reduction='mean', eps=1e-8):
...
class SoftDiceMetric(nn.Module):
    def __init__(self, dims=(2, 3, 4), activation='sigmoid', reduction='mean', eps=30):
        super(SoftDiceMetric, self).__init__()
        self.dims = dims
        self.activation = activation
        self.reduction = reduction
        self.eps = eps
