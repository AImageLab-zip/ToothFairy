...
Write-Host "Testing ToothFairy3 Interactive-Segmentation algorithm..."

# Define paths
$TEST_DATA_DIR = "C:\Path-to\test-data\ToothFairy3"
$IMAGES_DIR = Join-Path $TEST_DATA_DIR "imagesTr"
$RESULTS_DIR = "C:\Path-to\ToothFairy3\test-results"
