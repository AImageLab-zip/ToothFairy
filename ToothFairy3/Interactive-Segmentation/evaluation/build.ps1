# Build script for ToothFairy3 Interactive-Segmentation evaluation container
...
Write-Host "Building ToothFairy3 Interactive-Segmentation evaluation container..."
