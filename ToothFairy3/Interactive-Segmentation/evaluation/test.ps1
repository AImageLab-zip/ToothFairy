# Test script for ToothFairy3-Interactive-Segmentation evaluation container
...
# Define paths
$TEST_DATA_DIR = "Path-to\ToothFairy3\test-data\ToothFairy3"
$LABELS_DIR = Join-Path $TEST_DATA_DIR "labelsTr"
$RESULTS_DIR = "Path-to\ToothFairy3\test-results"
...
Write-Host "Running ToothFairy3 Interactive-Segmentation evaluation..."
