...
Write-Host "=== ToothFairy3 Interactive-Segmentation Pipeline ===" -ForegroundColor Green
Write-Host ""
...
Write-Host "  - Algorithm Output: test-results\algorithm-output"
Write-Host "  - Evaluation Output: \test-results\evaluation-output"
