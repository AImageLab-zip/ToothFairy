...
class Generic_UNet(SegmentationNetwork):
    ...
    def forward(self, x):
        ...
        #     print('x1-shape:')
        #     print(x.shape)
        # print('x-bottleneck-shape:')
        # print(x.shape)
        x = self.conv_blocks_context[-1](x)
        # print('after-x-bottleneck-shape:')
        # print(x.shape)
...
default_dict = {
    ...
    "net_conv_kernel_sizes": [[1, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3]],
...
def initialize_nnunet_small(threeD=True, num_classes=2):
    """
    ...
    network = Generic_UNet(default_dict["num_input_channels"], default_dict["base_num_features"], default_dict["num_classes"],
        ...
        default_dict["net_num_pool_op_kernel_sizes"], default_dict["net_conv_kernel_sizes"], False, True, True,max_num_features=256)
    print("nnUNet_small have {} paramerters in total".format(
