...
parser.add_argument("--trained_model",
                    type=str,
                    default="/home/tf/Checkpoints/ToothFairy/ResUNet/LQ_SYNTH2_folds_5_ResUnet18_tfloat32_nearest/model-ResUnet18-fold-0_current_best_val.pt",
