...
parser.add_argument("--debug",
                    type=bool,
                    default=False,
                    help="Debug mode - using less data.")
...
parser.add_argument("--first_cycle",
                    type=float,
                    default=0.3,
                    help="First cycle length ratio based on number of epochs.")
parser.add_argument("--cycle_mult",
                    type=float,
                    default=2.85,
                    help="Multiplier of cycles length - given first cycle length.")
...
parser.add_argument("--batch_size_val",
                    ...
                    default=1,
                    help="Number of items for dataloader batch.")
parser.add_argument("--crop_num_samples",
                    type=int,
                    default=2,
                    help="Number of samples during training to be randomly cropped.")
...
parser.add_argument("--finetune_training",
                    type=bool,
                    default=True,
                    help="if finetune training from checkpoint provided in trained_model")
parser.add_argument("--unfreeze2_epoch",
                    type=int,
                    default=101,
                    help="epoch to unfreeze weights of level -2")
parser.add_argument("--unfreeze3_epoch",
                    type=int,
                    default=-1,
                    help="epoch to unfreeze weights of level -3")
parser.add_argument("--trained_model",
                    type=str,
                    default="/home/tf/Checkpoints/ToothFairy/ResUNet/HQ_SYNTH2_ResUnet18_FP32_95/model-ResUnet18-fold-0_current_best_val.pt",
...
parser.add_argument("--checkpoint_dir",
                    type=str,
                    default='/home/tf/Checkpoints/ToothFairy',
                    help="Directory for model checkpoints") 
...
parser.add_argument("--tags",
                    type=str,
                    default='FINETUNE#HQ#RES18#GCRSOFT#FP32#CYCLE#FOLD5',
...
parser.add_argument("--metrics_interval",
                    type=int,
                    default=5,#10
                    help="Epochs interval between metrics calculation for all data.")
#INTERVALS
